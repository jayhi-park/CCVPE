...
import numpy as np
import math
from datasets_nuscenes import SatGrdDataset
...
label = 'Nuscenes_rotation_range' + str(rotation_range)
...
test1_set = SatGrdDataset(root=dataset_root, file=test1_file,
                              transform=(satmap_transform, grdimage_transform),
                              shift_range_lat=shift_range_lat,
                              shift_range_lon=shift_range_lon,
                              rotation_range=rotation_range,
...
test2_set = SatGrdDataset(root=dataset_root, file=test2_file,
                              transform=(satmap_transform, grdimage_transform),
                              shift_range_lat=shift_range_lat,
                              shift_range_lon=shift_range_lon,
                              rotation_range=rotation_range,
...
if training:
    ...
    for epoch in range(args['epochs']):  # loop over the dataset multiple times
        ...
        model_dir = f'/ws/LTdata/CCVPE/checkpoints/models/NUSCENES/{args["save"]}/' + str(epoch) + '/'
        results_dir = f'/ws/LTdata/CCVPE/checkpoints/results/NUSCENES/{args["save"]}/' + str(epoch) + '/'
    ...
    test_model_path = f'/ws/LTdata/CCVPE/checkpoints/models/NUSCENES/{args["save"]}/{args["epochs"]-1}/model.pt'
